...
import ContactBackground from '../../assets/contact/contact-img.jpeg';
...
class Contact extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    let API_KEY = "user_ZwScCaeiqLvqGX9z4NJZI";

    // YOUR EMAIL.JS TEMPLATE ID
    let TEMPLATE_ID = "template_0cjehlb";
    ...
    return (
      <div id="contact">
        ...
        <div className="wrapper">
          ...
          <p className="font12">
           Feel free to send me a message regarding any type of projects or work.
          </p>
          <Row className="padding40">
            <Col md={12} lg={6}>
              <form id="contact-form" onSubmit={this.handleSubmit}>
                <h4 className="font30 weight800 padding0">Send Me a Message.</h4>
